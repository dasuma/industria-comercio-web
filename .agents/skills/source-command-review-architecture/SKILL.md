---
name: 'source-command-review-architecture'
...
# source-command-review-architecture

Use this skill when the user asks to run the migrated source command `review-architecture`.
