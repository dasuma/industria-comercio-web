...
import { formatCurrency, formatPercent, interpolate } from '@/utils/format';
import { getPradmaDict } from '../../dictionaries';
import { useSearchSanctions } from '../../data';
            ...
            <Table.Root>
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.Head className="text-right">{d.columns.minSanction}</Table.Head>
                  <Table.Head className="text-right">{d.columns.minSanctionAlt}</Table.Head>
              ...
              <Table.Body>
                {data.data.map(sanction => (
                  <Table.Row key={sanction.id} {...clickableRowProps(() => openEdit(sanction.id))}>
                    ...
                    <Table.Cell className="text-right tabular-nums">
                      {formatPercent(sanction.percentage)}
                    </Table.Cell>
                    <Table.Cell className="text-right tabular-nums">
                      {formatCurrency(sanction.minSanction)}
                    </Table.Cell>
                    <Table.Cell className="text-right tabular-nums">
                      {formatCurrency(sanction.minSanctionAlt)}
                    </Table.Cell>
